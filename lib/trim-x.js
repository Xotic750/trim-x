...
module.exports = function trim(string) {
  return trimLeft(trimRight(requireCoercibleToString(string)));
};

},{"require-coercible-to-string-x":6,"trim-left-x":9,"trim-right-x":10}],2:[function(_dereq_,module,exports){
/**
