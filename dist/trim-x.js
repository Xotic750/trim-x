...
exports.trim2016 = trim2016;
exports.default = trim2018;

var _trimLeftX = _interopRequireWildcard(__webpack_require__(2));

var _trimRightX = _interopRequireWildcard(__webpack_require__(3));
...
function trim2016(string) {
  return (0, _trimLeftX.trimLeft2016)((0, _trimRightX.trimRight2016)(string));
}
/**
 * This method removes whitespace from the left and right end of a string.
 * (ES2018).
...
function trim2018(string) {
  return (0, _trimLeftX.default)((0, _trimRightX.default)(string));
}
...
//# sourceMappingURL=trim-x.js.map